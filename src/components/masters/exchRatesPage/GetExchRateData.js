...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'currencydetails_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    ...
    {key: 3, label: "Exch Rate", field: 'exchangerate', width: 120, align: "right", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, editorOptions: {displayFormat: '#,##0.00', format: '#,##0.00'}, showZeroAsBlanks: true, required: true},
    {key: 4, label: "Currencies_id", field: 'currencies_id', width: 60, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, required: true},
