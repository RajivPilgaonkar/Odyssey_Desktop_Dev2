...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'trainstations_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Station (Rly)", field: 'station', width: 200, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 50}, hint: 'Station Name as per Railways'},  
    {key: 3, label: "Code", field: 'railwaycode', width: 100, align: "center", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 20}},  
    {key: 4, label: "Station", field: 'stationname', width: 200, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 50}, hint: 'Station name which gets printed'},  

    {key: 5, label: "Cities_id", field: 'cities_id', width: 60, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, required: true},
    {key: 6, label: "In Use?", field: 'in_use', width: 60, align: "center", dataType: 'boolean', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, booleanText: ['Yes','No'], required: true, default: true},
    {key: 7, label: "Order No.", field: 'DefaultOrder', width: 100, align: "center", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, default: 1, editorOptions: {format: '#,##0'}, showZeroAsBlanks: true},
