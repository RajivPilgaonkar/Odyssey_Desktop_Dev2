...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'PlaceOfSupply_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Place Of Supply", field: 'PlaceOfSupply', width: 300, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 50}},  
    {key: 3, label: "State", field: 'States_id', width: 300, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, required: true},  

    {key: 10, label: "Home State", field: 'Home', width: 100, align: "center", dataType: 'boolean', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, booleanText: ['Yes','No'], default: false},
