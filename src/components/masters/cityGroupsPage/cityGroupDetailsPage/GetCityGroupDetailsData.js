...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'CarHireGroupCities_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},

    {key: 2, label: "CarHireGroups_id", field: 'CarHireGroups_id', width: 100, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, colSpan: 1, required: true},  
    {key: 3, label: "City", field: 'Cities_id', width: 150, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, hint: 'City should be entered in Distances'},    
    {key: 4, label: "Order No.", field: 'OrderNo', width: 100, align: "center", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, default: 1, editorOptions: {format: '#,##0'}, showZeroAsBlanks: true},
    {key: 5, label: "Nights", field: 'Nights', width: 100, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, default: 1, editorOptions: {format: '#,##0'}, showZeroAsBlanks: true, required: true},
