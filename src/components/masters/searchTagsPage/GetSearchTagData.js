...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'SearchTags_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},

    {key: 2, label: "Search Tag", field: 'SearchTag', width: 300, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 30}},  
    {key: 3, label: "Order No.", field: 'OrderNo', width: 100, align: "center", dataType: 'number', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, default: 1, editorOptions: {format: '#,##0'}, showZeroAsBlanks: true},
