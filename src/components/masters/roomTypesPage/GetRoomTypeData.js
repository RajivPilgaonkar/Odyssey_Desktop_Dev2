...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'roomtypes_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Room Type", field: 'roomtype', width: 300, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 50}, hint: 'Room Type in Hotels', allowFilter: true},  
    {key: 3, label: "A/C", field: 'ac', width: 60, align: "center", dataType: 'boolean', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, booleanText: ['Yes','No'], required: true, default: true},
