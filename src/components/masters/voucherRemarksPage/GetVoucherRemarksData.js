...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'VoucherRemarks_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "VoucherRemarkTypes_id", field: 'VoucherRemarkTypes_id', width: 60, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, default: 1},

    {key: 3, label: "Remarks", field: 'VoucherRemarks', width: 600, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 3, editorType: 'dxTextArea', editorOptions: {maxLength: 200, height: 80}, required: true, hint: 'Provide any remarks which can later be included in the Vouchers. Limit to 200 char', allowFilter: true},    
