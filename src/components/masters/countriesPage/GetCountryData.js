...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'countries_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Country", field: 'country', width: 300, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 50}, allowFilter: true},  
    {key: 3, label: "ISD", field: 'isd', width: 80, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: true, allowFilter: true},  
    {key: 4, label: "Code", field: 'countrycode', width: 80, align: "center", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: true, editorOptions: {maxLength: 2}, allowFilter: true},  
    {key: 5, label: "Active", field: 'active', width: 60, align: "center", dataType: 'boolean', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, booleanText: ['Yes','No'], required: true, default: true},
    {key: 6, label: "Operate Business", field: 'OperateBusiness', width: 60, align: "center", dataType: 'boolean', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, booleanText: ['Yes','No'], required: true, default: false, hint: 'Tick you operate your business in that country'},
