...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'aircrafttypes_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Aircraft", field: 'aircraft', width: 300, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 10}, hint: 'Aircraft Type'},  
