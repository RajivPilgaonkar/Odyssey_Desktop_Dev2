...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'DefaultCarAgents_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Sr No", field: 'OrderNo', width: 60, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength:10}, hint: 'Aircraft Type'},  

    {key: 3, label: "Starts In", field: 'StartCities_id', width: 80, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, allowFilter: true},    
    {key: 4, label: "Ends In", field: 'EndCities_id', width: 80, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, allowFilter: true},    
    {key: 5, label: "Enters State", field: 'EnterStates_id', width: 100, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, allowFilter: true},    
    {key: 6, label: "Enters City", field: 'EnterCities_id', width: 100, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, allowFilter: true},        
    {key: 7, label: "Agent", field: 'AgentAddressbook_id', width: 400, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, required: true, allowFilter: true},    
