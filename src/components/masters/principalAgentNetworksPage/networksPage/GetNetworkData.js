...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'PrincipalAgentNetworks_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},

    {key: 2, label: "Network", field: 'PrincipalAgentNetwork', width: 200, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, editorOptions: {maxLength: 50}, required: true, hint: 'Provide any name to identify the Network'},    
