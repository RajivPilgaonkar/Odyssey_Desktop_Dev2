...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'PrincipalAgentNetworkDetails_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},

    {key: 2, label: "PA Networks ID", field: 'PricipalAgentNetworks_id', width: 60, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 3, label: "Principal Agent", field: 'Addressbook_id', width: 300, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, required: true},  

    {key: 5, label: "Short Name", field: 'ShortName', width: 100, align: "left", dataType: 'string', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 30}, hint: 'ex. in the Welcome Letter'},  
    {key: 6, label: "Part of", field: 'PartOf', width: 100, align: "left", dataType: 'string', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 100}, hint: 'ex. in the Welcome Letter'},  
