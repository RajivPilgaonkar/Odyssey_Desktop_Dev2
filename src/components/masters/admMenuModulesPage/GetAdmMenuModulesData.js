...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'AdmMenuModules_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Module No", field: 'AdmMenuModuleNo', width: 100, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, editorOptions: {format: '#,##0'}, showZeroAsBlanks: true},
    {key: 3, label: "Module", field: 'AdmMenuModule', width: 300, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 150}},  
    {key: 5, label: "Type", field: 'AdmModuleTypes_id', width: 130, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, allowFilter: true},    
