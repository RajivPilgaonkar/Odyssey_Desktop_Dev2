...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'FixedItin_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Quotation Ref", field: 'QuotationRef', width: 120, align: "center", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: true, editorOptions: {maxLength: 20}, allowFilter: true, hint: 'Used in Elements for Drives'},  
    {key: 3, label: "Title", field: 'Title', width: 350, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 254}, allowFilter: true},  
    {key: 4, label: "Addressbook_id", field: 'Addressbook_id', width: 80, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, colSpan: 1, required: false, default: 2137},  
    {key: 5, label: "Order No.", field: 'OrderNo', width: 100, align: "center", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, default: 1, editorOptions: {format: '#,##0'}, showZeroAsBlanks: true},
