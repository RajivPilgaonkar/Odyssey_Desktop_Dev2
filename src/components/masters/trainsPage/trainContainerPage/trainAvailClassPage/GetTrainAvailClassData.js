...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'TrainAvailableClass_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    ...
    {key: 3, label: "Class", field: 'Class_id', width: 200, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, required: true, allowFilter: true},    
