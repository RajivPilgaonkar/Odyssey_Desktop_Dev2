...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'QuoExclusionDetails_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},

    {key: 2, label: "Details", field: 'QuoExclusionDetail', width: 400, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 3, required: true, editorType: 'dxTextArea', editorOptions: {maxLength: 2000, readOnly: false, height: 110}},  
    {key: 3, label: "Sr No", field: 'SrNo', width: 100, align: "center", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, default: 1, editorOptions: {format: '#,##0'}, showZeroAsBlanks: true},
    {key: 4, label: "Display", field: 'Display', width: 60, align: "center", dataType: 'boolean', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, booleanText: ['Yes','No'], required: true, default: true},

    {key: 5, label: "Exclusions_id", field: 'QuoExclusions_id', width: 120, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, required: true},
