...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'TicketClassExceptions_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Train No", field: 'TrainNo', width: 100, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: true, editorOptions: {maxLength: 50}, allowFilter: true},  
    {key: 3, label: "Train", field: 'TrainName', width: 350, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: false, editorOptions: {maxLength: 200, readOnly: true}, isDbField: false, allowFilter: true},  
    ...
    {key: 5, label: "Class", field: 'Class_id', width: 150, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 1, required: true, allowFilter: true},    
