...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'RowID', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "From", field: 'FromNodeName', width: 200, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 20}},  
    {key: 3, label: "To", field: 'ToNodeName', width: 100, align: "center", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 20}},  

    {key: 4, label: "Kms", field: 'Cost2', width: 120, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: false, default: 0},  
    {key: 5, label: "Cumulative", field: 'Cost', width: 120, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: false, default: 0},  
