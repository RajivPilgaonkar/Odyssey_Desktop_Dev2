...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'ServiceTimings_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},

    {key: 2, label: "Services_id", field: 'Services_id', width: 100, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, colSpan: 1, required: true},  
    {key: 3, label: "Start Time", field: 'StartTime', width: 150, align: "left", dataType: 'string', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, required: true},    
    {key: 4, label: "Start Time", field: 'StringTime', width: 120, align: "center", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, editorOptions: {maxLength:5, mask: '00:00'}, hint: 'Ex. 23:15, 08:25', required: true, isDbField: false},    
