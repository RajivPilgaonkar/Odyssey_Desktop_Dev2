...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'vehicles_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Vehicle", field: 'vehicle', width: 200, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 35}},  
    {key: 3, label: "Plural", field: 'vehicle_plural', width: 200, align: "left", dataType: 'string', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 35}},  
    {key: 4, label: "Category", field: 'vehiclecategories_id', width: 200, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, required: true},    
    {key: 5, label: "Pax", field: 'pax', width: 80, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: true, default: 3, hint: 'Max Pax you recommend'},    
    {key: 6, label: "Seating", field: 'SeatingCapacity', width: 80, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: true, default: 3, hint: 'Actual capacity used for Entry Tax'},    
