...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'Consultants_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},

    {key: 2, label: "Consultant", field: 'Consultant', width: 200, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 60}, allowFilter: true},  
    ...
    {key: 3, label: "Email", field: 'Email', width: 300, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 100}},  
    ...
    {key: 11, label: "Write Up", field: 'WriteUp', width: 250, align: "left", dataType: 'string', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 3, editorType: 'dxTextArea', editorOptions: {maxLength:250, readOnly: false, height: 110}},    
