...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'AddressbookServices_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},

    {key: 2, label: "Service", field: 'AddressbookService', width: 200, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 30}},  
    ...
    {key: 4, label: "Sub-Category", field: 'ContactSubCategories_id', width: 120, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, required: true},
