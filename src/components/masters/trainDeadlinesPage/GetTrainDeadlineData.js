...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'TicketDeadlines_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Train No", field: 'TrainNo', width: 100, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: true, editorOptions: {maxLength:50}},  
    {key: 3, label: "Train", field: 'TrainName', width: 250, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: false, editorOptions: {maxLength:200, readOnly: true}, isDbField: false},  
    {key: 4, label: "Tickets_id", field: 'Tickets_id', width: 80, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, colSpan: 1, required: false, default: 2},  
    {key: 5, label: "Pax Deadline", field: 'DeadlinePaxDays', width: 120, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: false, default: 0, hint: 'In Days'},  
    {key: 6, label: "Name Deadline", field: 'DeadlineNameDays', width: 120, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: false, default: 0, hint: 'In Days'},  
