...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'InvExchRates_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    ...
    {key: 3, label: "Exch Rate", field: 'ExchangeRate', width: 120, align: "right", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, editorOptions: {displayFormat: '#,##0.000', format: '#,##0.000'}, showZeroAsBlanks: true, required: true},
