...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'BookingsTours_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    ...
    {key: 3, label: "Tour Code", field: 'TourCode', width: 100, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, required: true, editorOptions: {maxLength: 10}, allowFilter: true},  
    {key: 4, label: "Tour Date", field: 'TourDate', width: 100, align: "center", dataType: 'date', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, required: true, editorOptions: {displayFormat: 'dd/MM/yyyy'}},    
    ...
    {key: 10, label: "Booked On", field: 'BookedOn', width: 100, align: "center", dataType: 'date', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, editorOptions: {displayFormat: 'dd/MM/yyyy'}},    
    {key: 11, label: "Confirmed On", field: 'ConfirmedOn', width: 100, align: "center", dataType: 'date', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, editorOptions: {displayFormat: 'dd/MM/yyyy'}},    
    {key: 12, label: "Cancelled On", field: 'CancelledOn', width: 100, align: "center", dataType: 'date', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, editorOptions: {displayFormat: 'dd/MM/yyyy'}},    
    
    {key: 20, label: "Tour Leader", field: 'TourLeader', width: 60, align: "center", dataType: 'boolean', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, default: true, allowFilter: true, booleanText: ['Yes','No']},
    {key: 21, label: "Tour Leader Trainee", field: 'TourLeaderTrainee', width: 60, align: "center", dataType: 'boolean', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, default: true, allowFilter: true, booleanText: ['Yes','No']},
