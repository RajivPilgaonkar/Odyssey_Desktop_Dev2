...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'FitMargins_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},

    {key: 2, label: "Description", field: 'TrsTypeDesc', width: 200, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, editorOptions: {maxLength: 50}, required: true, hint: 'Provide any name to identify this margin'},    
    ...
    {key: 3, label: "Trs Type", field: 'TrsType', width: 80, align: "center", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, required: true},

    {key: 21, label: "From Amt", field: 'FromAmt', width: 100, align: "right", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, editorOptions: {displayFormat: '#,##0', format: '#,##0'}, default: 0},    
    {key: 22, label: "To Amt", field: 'ToAmt', width: 100, align: "right", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, editorOptions: {displayFormat: '#,##0', format: '#,##0'}, default: 0},    
    {key: 23, label: "Margin (%)", field: 'Margin', width: 100, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, editorOptions: {displayFormat: '#,##0', format: '#,##0'}, default: 0},    
