...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'mealplans_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Meal Plan", field: 'mealplan', width: 300, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength: 15}, hint: 'Continental Plan, Jungle Plan ...'},  
    {key: 3, label: "Short", field: '[plan]', width: 100, align: "center", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: true, editorOptions: {maxLength: 3}, hint: 'CP, JP, ...'},  
