...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'airlines_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 2, label: "Airline", field: 'airline', width: 300, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, required: true, editorOptions: {maxLength:50}, hint: 'Indigo, GoAir ...'},  
    {key: 3, label: "Code", field: 'code', width: 80, align: "center", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, required: false, editorOptions: {maxLength:2}},  
