...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'TransferCityPairs_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},

    {key: 2, label: "From City", field: 'FromCities_id', width: 150, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 1, allowFilter: true, required: true},    
    {key: 3, label: "To City", field: 'ToCities_id', width: 150, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 1, allowFilter: true, required: true},    
