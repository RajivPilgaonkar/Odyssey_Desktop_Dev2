...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'StateCrossings_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    ...
    {key: 3, label: "State", field: 'States_id', width: 150, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, hint: 'City should be entered in Distances', required: true},    
