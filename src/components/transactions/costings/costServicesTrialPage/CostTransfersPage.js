...
class CostTransfersPage extends Component {
  _isMounted = false;
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(CostTransfersPage));
