...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'costservicesothers_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, editorOptions: {readOnly: true}, allowSort: false},
    ...
    {key: 8, label: "Cost Per Person", field: 'costperperson', width: 120, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 1, required: true, default: 0, editorOptions: {displayFormat: '#,##0', format: '#,##0'}, showZeroAsBlanks: true},
    {key: 9, label: "Cost Per Group", field: 'costpergroup', width: 120, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 1, required: true, default: 0, editorOptions: {displayFormat: '#,##0', format: '#,##0'}, showZeroAsBlanks: true},
    {key: 10, label: "Nett", field: 'nett', width: 60, align: "center", dataType: 'boolean', visible: true, visibleInForm: true, isLookup: false, groupNo: 1, default: false, allowFilter: false, booleanText: ['Yes','No']},
    {key: 11, label: "T/L Free", field: 'tourleaderfree', width: 70, align: "center", dataType: 'boolean', visible: true, visibleInForm: true, isLookup: false, groupNo: 1, default: false, allowFilter: false, booleanText: ['Yes','No']},
    {key: 12, label: "For Residents", field: 'resident', width: 120, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 1, required: true, default: 4},

    {key: 13, label: "Special GST (%)", field: 'SpecialGst', width: 120, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 1, default: 0, editorOptions: {format: '#,##0.00'}, showZeroAsBlanks: true},
    ...
    // redundant fields
    {key: 16, label: "T/L", field: 'tourleader', width: 70, align: "center", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 4, default: 0, allowFilter: false},
