...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'costservicesguides_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, editorOptions: {readOnly: true}, allowSort: false},
    ...
    {key: 7, label: "To Pax", field: 'topax', width: 60, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 1, required: true, default: 4, editorOptions: {displayFormat: '#,##0', format: '#,##0'}, showZeroAsBlanks: true},
