...
class CostAccommodationPage extends Component {
  _isMounted = false;
  ...
  fetchInitialData = async() => {
    await this.props.setWebPage_action(WEBPAGE_COST_ACCOMMODATION);
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(CostAccommodationPage));
