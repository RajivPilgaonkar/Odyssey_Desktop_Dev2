...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'CostServicesTransport_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
    ...
    {key: 20, label: "Cost AC", field: 'CostAc', width: 70, align: "center", dataType: 'number', visible: false, visibleInForm: true, isLookup: false, groupNo: 1, required: false, default: 0, editorOptions: {displayFormat: '#,##0', format: '#,##0'}, showZeroAsBlanks: true},
    ...
    {key: 21, label: "Parking", field: 'ParkingFee', width: 70, align: "center", dataType: 'number', visible: false, visibleInForm: true, isLookup: false, groupNo: 1, required: false, default: 0, editorOptions: {displayFormat: '#,##0', format: '#,##0'}, showZeroAsBlanks: true},
    {key: 22, label: "Road Tax", field: 'RoadTaxPerDay', width: 80, align: "center", dataType: 'number', visible: false, visibleInForm: true, isLookup: false, groupNo: 1, required: false, default: 0, editorOptions: {displayFormat: '#,##0', format: '#,##0'}, showZeroAsBlanks: true},
    ...
    {key: 24, label: "Sp. GST (%)", field: 'ChargedGst', width: 120, align: "center", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 1, default: 0, editorOptions: {format: '#,##0.00'}, showZeroAsBlanks: true, isDbField: false},
    {key: 25, label: "Nett", field: 'Nett', width: 50, align: "center", dataType: 'boolean', visible: false, visibleInForm: true, isLookup: false, groupNo: 1, default: false, allowFilter: false, booleanText: ['Yes','No'], hint: 'If ticked, iclusive of tax'},

    {key: 41, label: "Meet & Assist", field: 'MeetAndAssist', width: 110, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 2, required: false, default: 0, editorOptions: {displayFormat: '#,##0', format: '#,##0'}, showZeroAsBlanks: true},
    {key: 42, label: "Entry A/P", field: 'EntryAp', width: 80, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 2, required: false, default: 0, editorOptions: {displayFormat: '#,##0', format: '#,##0'}, showZeroAsBlanks: true},
    {key: 505, label: "EmptyItem", field: 'EmptyItem', width: 0, align: "left", dataType: 'emptyItem', visible: false, visibleInForm: true, isLookup: false, groupNo: 2, required: false, colSpan: 1},

    {key: 43, label: "Sp. GST M&A(%)", field: 'SpecialGst2', width: 130, align: "center", dataType: 'number', visible: false, visibleInForm: true, isLookup: false, groupNo: 2, editorOptions: {}, showZeroAsBlanks: false, hint: 'Blank for default GST rate'},
    {key: 44, label: "Sp. GST M&A(%)", field: 'ChargedGst2', width: 120, align: "center", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 2, default: 0, editorOptions: {format: '#,##0.00'}, showZeroAsBlanks: true, isDbField: false},
    {key: 45, label: "Nett M&A", field: 'Nett2', width: 80, align: "center", dataType: 'boolean', visible: true, visibleInForm: true, isLookup: false, groupNo: 2, default: false, allowFilter: false, booleanText: ['Yes','No'], hint: 'If ticked, iclusive of tax'},
