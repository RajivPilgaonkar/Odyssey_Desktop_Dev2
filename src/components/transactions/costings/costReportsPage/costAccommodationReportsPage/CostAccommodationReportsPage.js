...
import CostAccommodationReports from './CostAccommodationReports';
...
class CostAccommodationReportsPage extends Component {
  _isMounted = false;
  ...
  fetchInitialData = async() => {
    await this.props.setWebPage_action(WEBPAGE_COST_ACCOMMODATION_REPORTS);
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(CostAccommodationReportsPage));
