...
export const tableHeaderArray = 
  [ {key: 1, label: "ID", field: 'Seasons_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0, editorOptions: {readOnly: true}, allowSort: false},
    ...
    {key: 6, label: "Travel Agent Commission (%)", field: 'Tac', width: 220, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, default: 0, editorOptions: {format: '#,##0.00'}, showZeroAsBlanks: true},
    {key: 7, label: "Travel Agent Commission on Meal Plan", field: 'TacOnMealPlan', width: 300, align: "center", dataType: 'boolean', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, default: true, allowFilter: false, booleanText: ['Yes','No']},

    {key: 100, label: "On", field: 'ModifiedOn', width: 60, align: "center", dataType: 'date', visible: false, visibleInForm: true, isLookup: false, groupNo: 1, editorOptions: {displayFormat: 'dd/MM/yyyy', readOnly: true}},
    {key: 101, label: "By", field: 'ModifiedByUsers_id', width: 60, align: "center", dataType: 'number', visible: false, visibleInForm: true, isLookup: true, groupNo: 1, editorOptions: {readOnly: true}},

    // redundant fields
    {key: 201, label: "TAC PT (%)", field: 'Tac_pt', width: 110, align: "center", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 1, default: 0, editorOptions: {format: '#,##0.00'}, showZeroAsBlanks: true},
