...
[ 
  ...
  {key: 1, label: "ID", field: 'ElemExtraDayCarHireCosts_id', width: 60, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0},
  {key: 2, label: "Elements Car ID", field: 'ElemExtraDayCarHire_id', width: 60, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0},  
  ...
  {key: 22, label: "Vehicle", field: 'Vehicles_id', width: 100, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 1, editorOptions: {displayFormat: '#,##0', format: '#,##0'}, showZeroAsBlanks: true, required: true},
