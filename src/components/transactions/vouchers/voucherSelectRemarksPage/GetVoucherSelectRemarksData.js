...
export const tableHeaderArray = 
  [ 
    {key: 1, label: "ID", field: 'VoucherRemarks_id', width: 60, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0},
    {key: 7, label: "Remarks", field: 'VoucherRemarks', width: 600, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, editorType: 'dxTextArea', editorOptions: {maxLength:200, readOnly: false, height: 80}, colSpan: 3},    
    {key: 8, label: "Select", field: 'Select', width: 100, align: "center", dataType: 'boolean', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, booleanText: ['Yes','No'], default: true, isDbField: false},
  ];
