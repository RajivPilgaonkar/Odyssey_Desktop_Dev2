...
[ {key: 1, label: "ID", field: 'QuoCities_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
  ...
  {key: 3, label: "Date", field: 'DateIn', width: 110, align: "center", dataType: 'date', visible: true, visibleInForm: true, isLookup: false, groupNo: 1, editorOptions: {displayFormat: 'dd/MM/yyyy', readOnly: true}},
  {key: 4, label: "City", field: 'ToCities_id', width: 120, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: true, groupNo: 1, colSpan: 2, editorOptions: {maxLength:100, readOnly: true}},    
  {key: 5, label: "Nights", field: 'Nights', width: 80, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: false, groupNo: 1, editorOptions: {format: '##0', readOnly: true}},  
  {key: 6, label: "Mode", field: 'ModeOfTravel', width: 250, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 1, colSpan: 2, editorOptions: {maxLength:100, readOnly: true}, isDbField: false},    
  {key: 8, label: "Module", field: 'ModuleQuotations_id', width: 250, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 1, colSpan: 2, hint: 'If drop-down is blank, go to Riksja Modules / Copy all Quotations to next year'},  
];
