...
[ {key: 1, label: "ID", field: 'Quo_AgentList_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0, isDbField: false},
  ...
  {key: 3, label: "Hotel/Agent", field: 'Addressbook_id', width: 250, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, required: true},  
  {key: 4, label: "Alternative", field: 'Alt_Addressbook_id', width: 250, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, required: false},  

  {key: 5, label: "Selected", field: 'Selected', width: 100, align: "center", dataType: 'boolean', visible: true, visibleInForm: false, isLookup: false, groupNo: 0, booleanText: ['Yes','No'], default: true},
