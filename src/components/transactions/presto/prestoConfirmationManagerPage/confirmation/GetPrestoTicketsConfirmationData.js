...
[ 
  ...
  {key: 2, label: "ID", field: 'QuoTickets_id', width: 60, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0},
  ...
  {key: 25, label: "Travel On", field: 'ServiceDate', width: 75, align: "center", dataType: 'date', visible: true, visibleInForm: true, isLookup: false, groupNo: 1, editorOptions: {displayFormat: 'dd/MM/yy', readOnly: true}, allowFilter: true},
  {key: 26, label: "Booked On", field: 'BookingDate', width: 75, align: "center", dataType: 'date', visible: true, visibleInForm: true, isLookup: false, groupNo: 1, editorOptions: {displayFormat: 'dd/MM/yy', readOnly: true}},

  {key: 31, label: "Description", field: 'ServiceString', width: 220, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 2, editorType: 'dxTextArea', editorOptions: {maxLength:1000, readOnly: true, height: 80}, colSpan: 3, allowFilter: true},    
  {key: 32, label: "Remarks", field: 'Remarks', width: 80, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 2, editorType: 'dxTextArea', editorOptions: {maxLength:1000, readOnly: true, height: 80}, colSpan: 3},    
